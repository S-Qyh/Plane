...
public class GameWin extends JFrame implements Runnable {
    ...
    //英雄机
    PlaneObj planeObj = new PlaneObj(heroimg, 125, 580, 50, 41, 0, this);
...
//            fireObj.paintSelf(g);
    ...
    public void createdObj() {
        if (count % 20 == 0) {
            ...
            gameObj.add(fireList.get(fireList.size() - 1));
            // 添加飞机到游戏物体集合
            gameObj.add(new EnemyObj(GameUtils.enemyPlane,enemyPlane.getX(),enemyPlane.getY(),71,48,5,this));
        }
